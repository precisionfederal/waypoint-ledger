...
export const viewport: Viewport = { width: 'device-width', initialScale: 1, viewportFit: 'cover', themeColor: [{ media: '(prefers-color-scheme: light)', color: '#0e2a3a' }, { media: '(prefers-color-scheme: dark)', color: '#0e1a24' }] };
